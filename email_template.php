...
<body>
   ...
   <div class="email-container">
      ...
      <p style="line-height: 2;font-size: 20px;word-spacing: 2;"><span style="font-weight:bold ;margin-top:10px;">Hello <?= $_SESSION["fname"] ?> <?= $_SESSION["lname"] ?>,</span><br>
      <div style="padding: 20px;line-height: 2;font-size: 20px;word-spacing: 2;">
         ...
         Date / Time <span class="emoji"> &#128198;</span> : <?= $_SESSION["event_date"] ?><br>
